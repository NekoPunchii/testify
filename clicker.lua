...
--// UI Library \\--
local Library = loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/NekoPunchii/testify/refs/heads/main/libraryto'))()
local Window = Library:CreateWindow("AutoClicker by Neko")
